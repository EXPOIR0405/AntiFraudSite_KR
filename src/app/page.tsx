...
import { Search, AlertTriangle, Info, Users, ChevronRight, Menu, X } from 'lucide-react';
...
const RefinedScamWatchHomepage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto py-4 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <img src="https://placehold.co/50x50" alt="Logo" className="h-8 w-8 sm:h-10 sm:w-10" />
              <div className="text-xl sm:text-2xl font-bold text-indigo-700">사기예방센터</div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input type="text" placeholder="검색" className="hidden sm:block border border-gray-300 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              <button className="bg-indigo-600 text-white p-2 rounded-full hover:bg-indigo-700 transition duration-300">
                <Search className="h-5 w-5" />
              </button>
              <button 
                className="md:hidden bg-indigo-600 text-white p-2 rounded-full hover:bg-indigo-700 transition duration-300"
                onClick={toggleMenu}
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-md">
            <nav className="flex flex-col p-4">
              <a href="#" className="text-gray-600 hover:text-indigo-700 py-2">사기 유형</a>
              <a href="#" className="text-gray-600 hover:text-indigo-700 py-2">보호 방법</a>
              <a href="#" className="text-gray-600 hover:text-indigo-700 py-2">신고하기</a>
              <a href="#" className="text-gray-600 hover:text-indigo-700 py-2">리소스</a>
            </nav>
          </div>
        )}
      </header>
      ...
      {/* Hero section */}
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-12 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">당신의 안전한 경제활동을 지원합니다</h1>
            <p className="text-lg sm:text-xl mb-6 sm:mb-8">사기로부터 자신을 보호하는 방법을 배우고, 최신 사기 수법에 대해 알아보세요.</p>
            <button className="bg-white text-indigo-600 px-4 sm:px-6 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold hover:bg-gray-100 transition duration-300">
              자세히 알아보기
            </button>
          </div>
        </div>
      ...
      <section className="bg-gray-100 py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-black">최신 사기 뉴스 및 경고</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden">
                <img src={`https://placehold.co/400x${200 + index * 50}`} alt="News thumbnail" className="w-full h-48 object-cover" />
                <div className="p-6">
